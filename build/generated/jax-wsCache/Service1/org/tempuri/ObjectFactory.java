...
public class ObjectFactory {
    ...
    private final static QName _InsertPersPNombres_QNAME = new QName("http://tempuri.org/", "pNombres");
    ...
    private final static QName _UpdateUserPassPCorreo_QNAME = new QName("http://tempuri.org/", "pCorreo");
    private final static QName _UpdateUserPassPClave_QNAME = new QName("http://tempuri.org/", "pClave");
    ...
    public JAXBElement<String> createInsertPersPNombres(String value) {
        return new JAXBElement<String>(_InsertPersPNombres_QNAME, String.class, InsertPers.class, value);
    }
    ...
    public JAXBElement<String> createUpdateUserPassPCorreo(String value) {
        return new JAXBElement<String>(_UpdateUserPassPCorreo_QNAME, String.class, UpdateUserPass.class, value);
    }
    ...
    public JAXBElement<String> createUpdateUserPassPClave(String value) {
        return new JAXBElement<String>(_UpdateUserPassPClave_QNAME, String.class, UpdateUserPass.class, value);
    }
    ...
    public JAXBElement<String> createCreaUserPClave(String value) {
        return new JAXBElement<String>(_UpdateUserPassPClave_QNAME, String.class, CreaUser.class, value);
    }
    ...
    public JAXBElement<String> createCreaUserPCorreo(String value) {
        return new JAXBElement<String>(_UpdateUserPassPCorreo_QNAME, String.class, CreaUser.class, value);
    }
    ...
    public JAXBElement<String> createCreaUserPNombres(String value) {
        return new JAXBElement<String>(_InsertPersPNombres_QNAME, String.class, CreaUser.class, value);
    }
